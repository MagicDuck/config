...
elseif (&term == "builtin_gui")
    ...
    "
    highlight Boolean					guifg=DarkOrchid3
    highlight Character					guifg=RoyalBlue3
    highlight Constant					guifg=MediumOrchid3
    highlight Float					guifg=MediumOrchid4 
    highlight Number					guifg=DarkOrchid4 
    highlight String					guifg=RoyalBlue4  
    "
    ...
    "
    highlight Define					guifg=brown4	    
    highlight Include					guifg=firebrick3   
    highlight Macro						guifg=brown3	    
    highlight PreCondit					guifg=red	    
    highlight PreProc					guifg=firebrick4 
    "
    " Group: type group {{{3
    "
    ...
    highlight SpecialChar				guifg=DeepPink	   
    highlight Tag					guifg=DarkSlateBlue 
    highlight Delimiter					guifg=DarkOrchid 
    ...
    highlight oCursor	     guifg=bg	 guibg=DarkOrange
